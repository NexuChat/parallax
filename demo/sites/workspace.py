...
class WorkspaceSite:
    ...
    def _css(theme: str) -> str:
        ...
        return (
            ...
            ".landing{padding-block:clamp(4rem,14vh,10rem)}.landing h1{max-inline-size:12ch;font-size:clamp(2.5rem,8vw,5.5rem);line-height:1.02}.eyebrow{color:var(--accent);font-weight:700}.button,button{display:inline-block;border:0;border-radius:.5rem;background:var(--accent);color:#062116;padding-block:.7rem;padding-inline:1rem;font:inherit;font-weight:700;cursor:pointer}"
            ".auth{max-inline-size:28rem}.auth form{display:grid;gap:1rem}.auth label{display:grid;gap:.35rem}input{inline-size:100%;border:1px solid var(--line);border-radius:.4rem;background:var(--panel);color:var(--text);padding-block:.7rem;padding-inline:.8rem}.error{color:#c92a2a}.workspace{display:grid;grid-template-columns:minmax(10rem,14rem) minmax(0,1fr);gap:2rem}.workspace aside{display:grid;align-content:start;gap:.75rem}.workspace section{min-inline-size:0}.messages{display:grid;gap:.75rem;margin-block:1rem}.message{display:grid;gap:.2rem;background:var(--panel);border:1px solid var(--line);border-radius:.6rem;padding-block:.8rem;padding-inline:1rem}.message strong{color:var(--accent)}"
            ".composer{position:relative;display:grid;grid-template-columns:1fr auto;gap:.75rem;padding-block-start:3rem}.composer-tools{position:absolute;left:.75rem;margin-left:.25rem;inset-block-start:.4rem;display:flex;gap:.75rem;font-size:.85rem;color:var(--muted)}.composer-tools input{inline-size:auto}.sr-only{position:absolute;inline-size:1px;block-size:1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap}@media (max-width:42rem){header{align-items:flex-start;flex-direction:column}.workspace{grid-template-columns:1fr}.workspace aside{grid-auto-flow:column;justify-content:start}.composer{grid-template-columns:1fr}}"
        )
