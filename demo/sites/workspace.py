...
class WorkspaceSite:
    ...
    def _css(theme: str) -> str:
        ...
        dark_border = (".site-header{border-block-end:3px solid var(--accent)}" if theme == "dark" else "") + ".composer-tools button{min-block-size:44px!important;min-inline-size:44px!important}.composer-tools input{block-size:44px!important;inline-size:44px!important;min-block-size:44px!important}.check input{inline-size:44px!important;min-block-size:44px!important}"
