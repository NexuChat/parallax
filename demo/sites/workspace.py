...
class WorkspaceSite:
    ...
    def _css(theme: str) -> str:
        ...
        border = "html[data-theme=\"dark\"] .site-header{border-block-end:3px solid var(--accent)}@media (prefers-color-scheme: dark){html[data-theme=\"system\"] .site-header{border-block-end:3px solid var(--accent)}}.composer-tools button{min-block-size:44px!important;min-inline-size:44px!important}.composer-tools input{block-size:44px!important;inline-size:44px!important;min-block-size:44px!important}.check input{inline-size:44px!important;min-block-size:44px!important}"
