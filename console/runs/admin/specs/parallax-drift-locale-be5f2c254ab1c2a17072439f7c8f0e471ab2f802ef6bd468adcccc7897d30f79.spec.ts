 ...
 * Finding: drift-locale-8745201aebb5b0fb
 * Axis: locale
...
test("Parallax: drift-locale-8745201aebb5b0fb", async ({ page }) => {
  ...
  const reached = !isLoginPage && await page.locator("button.tap.primary").isVisible();
