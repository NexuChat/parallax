 ...
 * Finding: divergence-viewport-8f7469b3d4e05316
 * Axis: viewport
 * Evidence: owner-en-light-desktop=partial · owner-en-light-mobile=partial · gemini-embedding-001 similarity=0.878; equivalence threshold=0.90
...
test("Parallax: divergence-viewport-8f7469b3d4e05316", async ({ page }) => {
  ...
  expect(contentSignature).toBe("16dcc5c2");
});
