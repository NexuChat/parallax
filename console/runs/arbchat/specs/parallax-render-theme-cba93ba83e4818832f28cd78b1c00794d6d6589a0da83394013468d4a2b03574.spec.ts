 ...
 * Finding: render-theme-83c66bb9a3cbacac-theme_layout_shift
 * Axis: theme
...
test("Parallax: render-theme-83c66bb9a3cbacac-theme_layout_shift", async ({ browser }) => {
  ...
  try {
    ...
    await Promise.all([baselinePage.goto("/features"), variantPage.goto("/features")]);
