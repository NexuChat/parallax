 ...
 * Finding: divergence-privilege-7f4c5a1cb7cd5198
 * Axis: privilege
 * Evidence: member-en-light-desktop=partial
...
test("Parallax: divergence-privilege-7f4c5a1cb7cd5198", async ({ page }) => {
  ...
  expect(contentSignature).toBe("85859944");
});
