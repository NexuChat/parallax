 ...
 * Finding: render-theme-8f7469b3d4e05316-theme_layout_shift
 * Axis: theme
...
test("Parallax: render-theme-8f7469b3d4e05316-theme_layout_shift", async ({ browser }) => {
  ...
  try {
    ...
    await Promise.all([baselinePage.goto("/"), variantPage.goto("/")]);
