 ...
 * Finding: render-baseline-8f7469b3d4e05316-clipped
 * Axis: baseline
 * Evidence: owner-en-light-desktop=partial · member-en-light-desktop=partial · owner-en-dark-desktop=partial · owner-en-light-mobile=partial · owner-en-light-tablet=partial
...
test("Parallax: render-baseline-8f7469b3d4e05316-clipped", async ({ page }) => {
