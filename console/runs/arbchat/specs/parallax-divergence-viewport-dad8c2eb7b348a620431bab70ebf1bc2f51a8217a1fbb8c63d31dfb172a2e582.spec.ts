 ...
 * Finding: divergence-viewport-2cf4be103e26321f
 * Axis: viewport
 * Evidence: owner-en-light-desktop=partial · owner-en-light-mobile=partial · semantic comparison degraded: changed visible region was not captured; falling back to hash mismatch
...
test("Parallax: divergence-viewport-2cf4be103e26321f", async ({ page }) => {
