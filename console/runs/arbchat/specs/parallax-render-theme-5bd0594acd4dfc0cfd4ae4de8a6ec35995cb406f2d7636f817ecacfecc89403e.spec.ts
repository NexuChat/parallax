 ...
 * Finding: render-theme-6b7e8dfd60865710-theme_layout_shift
 * Axis: theme
...
test("Parallax: render-theme-6b7e8dfd60865710-theme_layout_shift", async ({ browser }) => {
  ...
  try {
    ...
    await Promise.all([baselinePage.goto("/app"), variantPage.goto("/app")]);
