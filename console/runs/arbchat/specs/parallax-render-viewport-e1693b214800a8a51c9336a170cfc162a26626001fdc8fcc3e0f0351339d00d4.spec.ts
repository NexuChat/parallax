 ...
 * Finding: render-viewport-2cf4be103e26321f-small_tap_target
 * Axis: viewport
...
test("Parallax: render-viewport-2cf4be103e26321f-small_tap_target", async ({ page }) => {
  ...
  const box = await page.locator("div.min-h-screen > div.min-h-screen.flex > div.relative.w-full:nth-of-type(2) > div.relative.w-full:nth-of-type(1) > a.mb-4.inline-flex").boundingBox();
