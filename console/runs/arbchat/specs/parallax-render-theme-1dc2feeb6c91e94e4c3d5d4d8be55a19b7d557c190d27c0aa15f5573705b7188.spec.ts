 ...
 * Finding: render-theme-7f4c5a1cb7cd5198-theme_layout_shift
 * Axis: theme
...
test("Parallax: render-theme-7f4c5a1cb7cd5198-theme_layout_shift", async ({ browser }) => {
  ...
  try {
    ...
    await Promise.all([baselinePage.goto("/about"), variantPage.goto("/about")]);
