 ...
 * Finding: render-baseline-22d481ed88f6d65e
 * Axis: baseline
 * Evidence: owner-en-light-desktop=partial · owner-ar-light-desktop=partial · owner-en-dark-desktop=partial · owner-en-light-mobile=partial · owner-en-light-tablet=partial
...
test("Parallax: render-baseline-22d481ed88f6d65e", async ({ page }) => {
