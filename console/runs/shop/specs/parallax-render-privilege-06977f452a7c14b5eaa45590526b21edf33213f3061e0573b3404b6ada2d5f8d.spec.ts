 ...
 * Finding: render-privilege-9fdb033848bfe4bb
 * Axis: privilege
 * Evidence: anon-en-light-desktop=partial
...
test("Parallax: render-privilege-9fdb033848bfe4bb", async ({ page }) => {
  const response = await page.goto("http://127.0.0.1:8099/shop?category=paper");
