 ...
 * Finding: render-privilege-c9c857931490069d
 * Axis: privilege
...
test("Parallax: render-privilege-c9c857931490069d", async ({ page }) => {
  const response = await page.goto("http://127.0.0.1:8099/shop?category=all");
