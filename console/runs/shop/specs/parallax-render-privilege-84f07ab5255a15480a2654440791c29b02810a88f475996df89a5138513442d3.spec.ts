 ...
 * Finding: render-privilege-ee3f2be42aa3a068
 * Axis: privilege
...
test("Parallax: render-privilege-ee3f2be42aa3a068", async ({ page }) => {
  const response = await page.goto("http://127.0.0.1:8099/shop?category=light");
