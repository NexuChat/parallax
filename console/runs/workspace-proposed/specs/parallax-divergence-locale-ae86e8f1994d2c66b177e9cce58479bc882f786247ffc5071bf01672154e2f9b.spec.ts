 ...
 * Finding: divergence-locale-e106e4fd085ef1d0
 * Axis: locale
...
test("Parallax: divergence-locale-e106e4fd085ef1d0", async ({ page }) => {
  ...
  const response = await page.goto("/workspace/settings");
  ...
  expect(contentSignature).toBe("dfb85db");
});
