 ...
 * Finding: escalation-privilege-e910102831c8e129
 * Axis: privilege
...
test("Parallax: escalation-privilege-e910102831c8e129", async ({ page }) => {
  const response = await page.goto("http://127.0.0.1:8099/control/");
