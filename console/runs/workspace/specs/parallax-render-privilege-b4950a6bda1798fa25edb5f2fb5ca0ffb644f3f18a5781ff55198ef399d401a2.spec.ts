 ...
 * Finding: render-privilege-59e0845cae72f335
 * Axis: privilege
 * Evidence: anon-en-light-desktop=blocked
...
test("Parallax: render-privilege-59e0845cae72f335", async ({ page }) => {
  const response = await page.goto("http://127.0.0.1:8099/workspace/settings");
