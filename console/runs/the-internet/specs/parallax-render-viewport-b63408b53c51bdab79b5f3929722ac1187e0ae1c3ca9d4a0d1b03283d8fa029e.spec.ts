 ...
 * Finding: render-viewport-99ed92cfbfa0e226-small_tap_target
 * Axis: viewport
...
test("Parallax: render-viewport-99ed92cfbfa0e226-small_tap_target", async ({ page }) => {
  const response = await page.goto("/abtest");
