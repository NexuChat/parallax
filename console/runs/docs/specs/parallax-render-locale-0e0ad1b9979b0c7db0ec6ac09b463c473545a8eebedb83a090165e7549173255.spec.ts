 ...
 * Finding: render-locale-5a111abb1f2098a7-untranslated
 * Axis: locale
 * Evidence: owner-en-light-desktop=reached · owner-ar-light-desktop=partial · gemini-embedding-001 similarity=0.960; equivalence threshold=0.90
...
test("Parallax: render-locale-5a111abb1f2098a7-untranslated", async ({ page }) => {
